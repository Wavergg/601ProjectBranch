<div class="container mt-2">
    ...
    <h3 class="text-secondary ml-0 my-3">Personal Information</h3>
    <hr />
    <div class="col-12">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                ...
                <input type="text" class="form-control" v-model="transportation" name="transportation" placeholder="Enter Transportation"
                    id="transportationID">
            </div>
        </div>
        <div class="row">
