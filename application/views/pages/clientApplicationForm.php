...
<div class="container mt-2" id="app">
    ...
    <div class="col-12 pb-5 pb-md-0">
            ...
            <div class="row mt-3">
             ...
             <div class="row mt-3">
            <input type="button" value="Add Client" @click="submitForm" class="btn btn-warning font-weight-bold m-0" :disabled="isButton">
            </div> 
            </form>
        ...
        methods: {
            submitForm: function(){
                if(this.city=="Enter City" || this.city.length<1){
                    ...
                    var urllink = "<?php echo base_Url(); ?>" + 'index.php/EmployerMission/addClient'
                    this.$http.post(urllink, formData).then(function(res) {
                        var result = res.body
                        this.message = res.body
                    }, function(res) {
                        this.message = "Failure in inserting client's data"
                    })
                    $('#myModal').modal('show');
                }
            },
