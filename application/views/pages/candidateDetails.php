<div id="app">
    ...
    <a
        href="<?php echo base_url();?>index.php/Jobs/assignCandidate/<?php echo $candidate['CandidateID'];?>/<?php echo $job['JobID'];?>">
                        ...
                        <div class="col-8">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" v-model="firstName" class="form-control" readonly
                                        v-bind:class="{ 'border-0': !toggleEdit}" id="firstNameID">
                                </div>
                                <div class="col-md-6">
                                    <label for="lastNameID" class="font-weight-bold mt-2">Applicant Last Name:</label>
                                    <input type="text" v-model="lastName" class="form-control" readonly
                                        v-bind:class="{ 'border-0': !toggleEdit}" id="lastNameID">
                                </div>
                                <!-- <div class="col-md-4">
                ...
                <div class="row ml-1"><a href="<?php echo base_url()?>index.php/CandidateMission/downloadCV/<?php echo $candidate['JobCV'];?>" id="candidateCVID" class="btn btn-primary">CandidateCV</a> </div>   
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" v-model="gender" class="form-control" readonly
                                        v-bind:class="{ 'border-0': !toggleEdit}" id="GenderID">
                                </div>
                                <div class="col-md-6">
                                    <label for="DOBID" class="font-weight-bold mt-2">Date Of Birth:</label>
                                    <input type="text" v-model="DOB" class="form-control" readonly
                                        v-bind:class="{ 'border-0': !toggleEdit}" id="DOBID">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-2">
                            ...
                            <input type="text" v-model="citizenship" class="form-control" readonly
                                v-bind:class="{ 'border-0': !toggleEdit}" id="citizenshipID">
                        </div>
                        <div class="col-md-2">
                            <label for="nationalityID" class="font-weight-bold mt-2">Nationality:</label>
                            <input type="text" v-model="nationality" class="form-control" readonly
                                v-bind:class="{ 'border-0': !toggleEdit}" id="nationalityID">
                        </div>
                        <div class="col-md-4">
                            <label for="passportCountryID" class="font-weight-bold mt-2">Passport Issued
                                Country:</label>
                            <input type="text" v-model="passportCountry" class="form-control" readonly
                                v-bind:class="{ 'border-0': !toggleEdit}" id="passportCountryID">
                        </div>
                        <div class="col-md-3">
                            <label for="passportNumberID" class="font-weight-bold mt-2">Passport Number:</label>
                            <input type="text" v-model="passportNumber" class="form-control" readonly
                                v-bind:class="{ 'border-0': !toggleEdit}" id="passportNumberID">
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-3">
                            <label for="workPermitNumberID" class="font-weight-bold mt-2">Work Permit Number:</label>
                            <input type="text" v-model="workPermitNumber" class="form-control" readonly
                                v-bind:class="{ 'border-0': !toggleEdit}" id="workPermitNumberID">
                        </div>
                        <div class="col-md-3">
                            <label for="workPermitExpiryID" class="font-weight-bold mt-2">Work Permit Expiry
                                Date:</label>
                            <input type="text" v-model="workPermitExpiry" class="form-control" readonly
                                v-bind:class="{ 'border-0': !toggleEdit}" id="workPermitExpiryID">
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-4">
                            <label for="CityID" class="font-weight-bold mt-2">City:</label>
                            <input type="text" v-model="city" class="form-control" readonly
                                v-bind:class="{ 'border-0': !toggleEdit}" id="CityID">
                        </div>
                        <div class="col-md-4">
                            <label for="SuburbID" class="font-weight-bold mt-2">Suburb:</label>
                            <input type="text" v-model="suburb" class="form-control" readonly
                                v-bind:class="{ 'border-0': !toggleEdit}" id="SuburbID">
                        </div>
                        <div class="col-lg-1 col-md-3">
                            <label for="ZipCodeID" class="font-weight-bold mt-2">ZipCode:</label>
                            <input type="text" v-model="zipCode" class="form-control" readonly
                                v-bind:class="{ 'border-0': !toggleEdit}" id="ZipCodeID">
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-8">
                            ...
                            <input type="text" v-model="address" class="form-control" readonly
                                v-bind:class="{ 'border-0': !toggleEdit}" id="AddressID">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" v-model="transportation" readonly
                                v-bind:class="{ 'border-0': !toggleEdit}" id="transportationID">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <label for="LicenseNumberID" class="font-weight-bold mt-2">NZ License Number:</label>
                            <input type="text" class="form-control" v-model="licenseNumber" readonly
                                v-bind:class="{ 'border-0': !toggleEdit}" id="LicenseNumberID">
                        </div>
                        <div class="col-md-4">
                            <label for="classLicenseID" class="font-weight-bold mt-2">Class License:</label>
                            <input type="text" class="form-control" v-model="classLicense" readonly
                                v-bind:class="{ 'border-0': !toggleEdit}" id="classLicenseID">
                        </div>
                        <div class="col-md-4">
                            <label for="endorsementID" class="font-weight-bold mt-2">Endorsement:</label>
                            <input type="text" class="form-control" v-model="endorsement" readonly
                                v-bind:class="{ 'border-0': !toggleEdit}" id="endorsementID">
                        </div>
                    </div>
    ...
    methods: {
        ...
        submitButton: function(candidateID, userID) {
            ...
            var urllink = "<?php echo base_Url(); ?>" +
                'index.php/CandidateMission/updateCandidateDetails/' + candidateID
            this.$http.post(urllink, formData).then(res => {
